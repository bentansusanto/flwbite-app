  ...
  return (
    <div className="p-6 space-y-6 bg-gray-50/50 dark:bg-[#06060a] min-h-screen">
      ...
      <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        ...
        {/* Branch Selector */}
        <div className="flex items-center gap-3 bg-white dark:bg-gray-950 p-1 rounded-xl border border-gray-200 dark:border-white/5 shadow-sm">
          ...
          <select
            ...
            className="bg-transparent border-none text-sm font-medium focus:ring-0 text-gray-700 dark:text-white pr-8"
          >
      ...
      <div className="grid grid-cols-1 gap-4 sm:grid-cols-3">
        <div className="rounded-2xl border border-gray-100 bg-white p-5 dark:border-white/5 dark:bg-gray-900/40 dark:backdrop-blur-md shadow-sm transition-all hover:shadow-md">
          ...
          <div className="mt-4">
            ...
            <p className="text-xs font-medium text-gray-500 uppercase tracking-wider">Tracked Variants</p>
          </div>
        </div>
        ...
        <div className="rounded-2xl border border-gray-100 bg-white p-5 dark:border-white/5 dark:bg-gray-900/40 dark:backdrop-blur-md shadow-sm transition-all hover:shadow-md">
          ...
          <div className="mt-4">
            ...
            <p className="text-xs font-medium text-gray-500 uppercase tracking-wider">Low Stock Alerts</p>
          </div>
        </div>
          ...
          <table className="w-full text-left">
            <thead>
              <tr className="border-b border-gray-100 bg-gray-50/50 dark:border-white/5 dark:bg-white/[0.03]">
                ...
                <th className="px-5 py-4 text-xs font-semibold uppercase tracking-wider text-gray-500">Product Name</th>
                <th className="px-5 py-4 text-xs font-semibold uppercase tracking-wider text-gray-500 text-center">Variants</th>
                <th className="px-5 py-4 text-xs font-semibold uppercase tracking-wider text-gray-500 text-center">Total Stock</th>
                    ...
                    <tr className={`group hover:bg-gray-50/50 dark:hover:bg-white/[0.02] transition-colors ${isExpanded ? 'bg-gray-50/50 dark:bg-white/[0.02]' : ''}`}>
                      ...
                      <td className="px-5 py-4">
                        <div className="flex items-center gap-3">
                          <div className="h-10 w-10 rounded-xl bg-indigo-50 dark:bg-indigo-500/10 flex items-center justify-center text-indigo-500">
                            <Package size={20} />
                          </div>
                          <div>
                            ...
                            <p className="text-[11px] text-gray-400 font-medium uppercase tracking-wider">Product</p>
                          </div>
                        </div>
                      </td>
                      <td className="px-5 py-4 text-center">
                            ...
                            <table className="w-full text-left">
                              <thead>
                                <tr className="text-gray-400">
                                  <th className="px-6 py-2.5 text-[10px] font-bold uppercase tracking-widest">Variant Name</th>
                                  {!selectedBranchId && <th className="px-6 py-2.5 text-[10px] font-bold uppercase tracking-widest">Branch</th>}
                                  <th className="px-6 py-2.5 text-[10px] font-bold uppercase tracking-widest text-center">Stock</th>
                                  <th className="px-6 py-2.5 text-[10px] font-bold uppercase tracking-widest text-center">Status</th>
                                </tr>
                              </thead>
                                ...
                                {group.variants.map((v: any) => {
                                  ...
                                  return (
                                    <tr key={v.id} className="hover:bg-gray-50/50 dark:hover:bg-white/[0.02] transition-colors">
                                      <td className="px-6 py-3 text-sm font-medium text-gray-600 dark:text-gray-400">{v.variant_name}</td>
                                      {!selectedBranchId && (
                                        <td className="px-6 py-3">
                                          <div className="flex items-center gap-1.5 text-[10px] font-bold text-indigo-500 bg-indigo-50/50 px-2 py-0.5 rounded-md w-fit">
                                            {v.branch_name}
                                          </div>
                                        </td>
                                      )}
                                      <td className="px-6 py-3 text-center text-sm font-bold text-gray-700 dark:text-gray-200">
                                        {v.actual_stock}
                                      </td>
