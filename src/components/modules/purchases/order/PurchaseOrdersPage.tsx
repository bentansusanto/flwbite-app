                ...
                <tr>
                  <td colSpan={5} className="py-16 text-center">
                    <div className="flex flex-col items-center justify-center text-gray-500 dark:text-gray-400">
                      ...
                      <p className="text-base font-bold text-gray-900 dark:text-white">Tidak ada data Purchase Order</p>
                      <p className="text-sm mt-1 max-w-sm">Data purchase order tidak ditemukan. Pastikan filter pencarian sudah benar.</p>
                    </div>
                  </td>
                </tr>
              )}
