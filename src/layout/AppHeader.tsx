            ...
            <form>
              <div className="relative">
                ...
                <input
                  ...
                  className="dark:bg-gray-950 h-11 w-full rounded-lg border border-gray-200 bg-transparent py-2.5 pl-12 pr-14 text-sm text-gray-800 shadow-theme-xs placeholder:text-gray-400 focus:border-brand-300 focus:outline-hidden focus:ring-3 focus:ring-brand-500/10 dark:border-white/5 dark:text-white/90 dark:placeholder:text-gray-500 dark:focus:border-brand-800 xl:w-[430px]"
                />
